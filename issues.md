...
UAT run 35 (2026-06-24, post-primary day 8): zero new issues, zero regressions. Scheduled data-refresh paired with UAT pass — June 23 budget vote final passage alert + June 21 DCBOE RCV detailed results / round-by-round tabulation both rendering on homepage + /issues/ranked-choice/. Static build verified: 101 routes, TypeScript strict, all 144 tests pass. Build date auto-renders 2026-06-24. Critical flows verified across desktop/tablet/mobile: homepage + alerts, address lookup, voting record matrix, candidate profiles, RCV page. All 7 sampled pages return 200, no console errors, no horizontal overflow at mobile (375px). No UAT-NNN filed. BL-UAT-19/20/22/23/24/25 + UAT-022 remain open with the human owner.
UAT run 34 (2026-06-23, post-primary day 7): zero new issues, zero regressions. Scheduled data-refresh and UAT pass paired — waiting for June 23 budget vote results; RCV detailed results from DCBOE expected on website (electionresults.dcboe.org). Static build verified: 101 routes, TypeScript strict, all 144 tests pass. Build date auto-renders 2026-06-23. No UAT-NNN filed. BL-UAT-19/20/22/23/24/25 + UAT-022 remain open with the human owner.
UAT run 33 (2026-06-22, post-primary day 6): zero new issues, zero regressions. Scheduled data-refresh and UAT pass paired — RCV detailed results from DCBOE expected on website (electionresults.dcboe.org), pending integration into alerts/recentMoves. Static build verified: 101 routes, TypeScript strict, all 144 tests pass. Build date auto-renders 2026-06-22. No UAT-NNN filed. BL-UAT-19/20/22/23/24/25 + UAT-022 remain open with the human owner.
UAT run 32 (2026-06-21, post-primary day 5): zero new issues, zero regressions. Scheduled data-refresh and UAT pass paired — full RCV results expected today from DCBOE; no new product updates needed. Static build verified: 101 routes, TypeScript strict, all 144 tests pass. Build date auto-renders 2026-06-21. No UAT-NNN filed. BL-UAT-19/20/22/23/24/25 + UAT-022 remain open with the human owner.
