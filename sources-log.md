...
_Last updated: 2026-06-01 (run 19 — scheduled 1-day-window pass, 15 days from primary. **Three verified additions this run, all closing-stretch endorsement events:** (1) DC NOW (DC Chapter of the National Organization for Women), 2026-06-01 — published a comprehensive slate covering mayor (Lewis George), AG (Schwalb), council chair (Mendelson), at-large/Bonds (Owolewa), at-large special (Silverman), Ward 1 (Raj), Ward 3 (Frumin), Ward 5 (Parker), Ward 6 (Allen). URL `dc-now.org/post/dcnow-endorses-d-c-council-candidates-in-2026-special-and-primary-elections` confirmed via WebFetch this run; surfaced as a new alert at the top of alerts.ts AND added as a news[] entry on every endorsed candidate's profile (9 candidates total). DCNOW's pick added to JLG's existing "progressive lane" newsTheme supportingUrls, Owolewa's "shadow-rep to challenger" theme, Raj's "leads March poll / consolidating endorsements" theme, Parker's Ward 5-incumbent theme, and Allen's Ward 6 incumbent theme — all confirmed to also appear in their respective news[] arrays. (2) Washington Blade Opinion (Peter Rosenstein), 2026-05-28 — "Dual endorsement for Independent Council-at-large: Patterson or Crawford" formalizes the cross-endorsement strategy in the at-large special race (rank Patterson #1, Crawford #2 to push past Silverman); added to both Crawford and Patterson's news[] (both well under cap). The cross-endorsement is the defining RCV-era strategic move in the special race. (3) New alert: today (June 1) is the deadline to **request** an out-of-DC mail ballot under DCBOE's "15 days before election" rule for voters who won't be in the District during the June 16 primary — sourced to dcboe.org/voters/casting-your-vote/mail-ballot-request. JLG cap held at 12 by dropping the 2026-04-29 WaPo OCF probe item (oldest entry, not load-bearing for newsThemes). Top alert updated from "Early voting begins in 8 days" (set 5/31) to "Early voting begins in 7 days" with date 2026-06-01 — same source PDF. Sweep also covered: WaPo mayoral editorial endorsement (still none through June 1 — Tracker remains in standing follow-up; the May 31 WaPo profiles are news-side and already documented in run 18); Trayon White January 2026 federal bribery trial status (no verdict yet found in June 1 results); FY27 first budget vote scheduled June 9 (already covered by alerts.ts May 10 entry; Committee of the Whole is in active markup with no surfaceable new date stamps); the WSWS DSA-affiliated profile of JLG dated 2025-12-11 surfaced this run but predates the cycle and is not added. The May 31 WaPo McDuffie piece has been retitled "...is the not-so-moderate moderate" on the WaPo site versus the URL-slug-derived headline we have in the dataset — left as is to avoid churn since the URL is the load-bearing key.)_

_Prior — run 18 (2026-05-31 — scheduled 3-day-window pass, 16 days from primary. **Five verified additions this run, all closing-stretch mayoral coverage:** (1) WaPo, 2026-05-31 — "The rise of Janeese Lewis George, who could be D.C.'s first democratic socialist mayor" (front-page closing-stretch profile, added to JLG news[] as primary citation; WebFetch returned 403 from the homepage, but the URL and headline are confirmed via WebSearch result listing + Wikipedia cross-reference + the parallel McDuffie WaPo piece on the same date — treated as load-bearing). (2) WaPo, 2026-05-31 — "In D.C. mayor's race, Kenyan R. McDuffie wants to offer 'more opportunities' for residents" (companion closing-stretch profile, added to McDuffie news[] as primary citation, same provenance as the JLG piece). (3) Washington Examiner, 2026-05-29 — "DC Police Union hits Lewis George over pension-fund affordable-housing proposal" (police union called the proposal an "automatic disqualifier" on X after the May 18 Fox 5 debate; added to JLG news[] AND surfaced as a new alert at the top of alerts.ts since the union pushback is the sharpest closing-stretch event of the 3-day window. WaPo opinion 2026-05-26 "play roulette with D.C. pensions" is the underlying piece that prompted the union's response; the WaExaminer piece is the more granular reporting that names the union's response — included as the primary citation rather than the opinion piece to keep editorial separation clean). (4) Washington Examiner, 2026-05-28 — "Exclusive: Janeese Lewis George backs safe injection sites in DC for drug use" (surfaces a May 2025 DSA endorsement-questionnaire response where Lewis George wrote "We need safe injection sites and harm reduction centers"; added to JLG news[]. Note: this is a Web fetch-confirmed quote, not a new statement, but the surfacing on 5/28 is the news event). (5) Axios DC, 2026-05-28 — "D.C. mayoral candidates sharpen final messages" (closing-stretch race-state piece confirmed via WebFetch; added to McDuffie news[] as the canonical "with under three weeks to go" frame). JLG cap held at 12 by dropping the May 21 GW Today forum (5 other candidates also carry it, so not load-bearing for JLG's profile), the May 20 City Cast DC poll (the poll's headline number is already in alerts.ts as the May 20 alert), and the May 14 WaPo Opinion schools-control piece (single-issue opinion, not in newsThemes.supportingUrls). McDuffie cap held at 12 by dropping the May 12 Washington Blade GLAA-ratings piece (single-issue rating, not in newsThemes) — leaving a 12-item news list focused on his endorsement and platform coverage. newsThemes not edited this run — the closing-stretch pension/safe-injection coverage hasn't yet hit the 14-day-mixed-outlet bar for a third theme; revisit next run if WaPo runs follow-up coverage. Top alert updated from "Early voting begins in 11 days" (set 5/28) to "Early voting begins in 8 days" with date 2026-05-31 — same source PDF. Sweep also covered: WaPo mayoral editorial endorsement (still none through 5/31 — Tracker remains in standing follow-up; the 5/31 WaPo profile is news-side, not the editorial board); Trayon White January 2026 federal bribery trial status (no verdict yet found in May 2026 results; trial scheduled for January 2026 per Wikipedia, possibly still in progress or postponed — not added as a recentMove without a date-stamped primary source); FY27 first budget vote scheduled June 9 (already covered by alerts.ts May 10 entry; no new development); Ward 6 (Allen vs. Nauden vs. Murphy) — GGW endorsement of Allen already noted; no fresh May 28-31 developments; at-large special (Crawford vs. Patterson vs. Silverman) — no new May 28-31 developments beyond the jonetta rose barras 5/29 piece (which is a generic field analysis, not candidate-level news). 51st 2026-05-28 voter guide already documented in run 17.)_

_Prior — run 17 (2026-05-28 — scheduled thin-window pass, 19 days from primary. **Three verified additions this run, all cleanups of earlier-month items that were missed:** (1) WaPo, 2026-04-29 — "Janeese Lewis George faces probe over D.C. mayoral campaign's ties to unions" (with corroborating Axios Apr 29, Washington City Paper Apr 27, and TheDCLine/jonetta May 1 — all four URLs documented in this log, only the WaPo piece added to JLG's news[] as the primary-source citation). The DC Office of Campaign Finance opened the probe on Apr 24 after a six-page complaint from Kevin Sobkoviak alleging coordination between JLG's campaign and the Safe & Affordable DC IE-PAC plus Unite Here Local 25 / SEIU 32BJ; campaign denies the allegations. Net JLG news[] held at 12 by dropping the Washington Blade May 14 "LGBTQ community must say NO" opinion (redundant with the other Blade May 14 endorsement entry already present) and the City Cast Apr 27 Charles Allen endorsement (already gestured to in newsThemes detail). The first newsTheme's supportingUrls was trimmed to drop the dead Charles Allen URL and the theme detail re-worded to drop the "council-colleague" hook so it still parses as load-bearing. (2) WaPo, 2026-05-14 — "Ads target D.C. mayoral hopefuls on crime, utilities ahead of June primary" — added to both JLG and McDuffie news[] (load-bearing first-major-TV-buy story, missed in prior 3 runs). McDuffie cap held at 12 by dropping the May 18 Hoya piece (redundant with FOX 5 on the same May 18 event). (3) DCBOE, drop-boxes reporting page — the electionStats "May 22 — Drop boxes open citywide" entry was upgraded with the concrete count "55 mail-ballot drop boxes citywide" and re-linked to dcboe.org/dcboe/media/PDFFiles/Drop-Boxes-Reporting.pdf (more durable URL than the bare homepage). Forward-looking alert added at the top of alerts.ts: "Early voting begins in 11 days — June 8 to 14 at every Vote Center, 8:30am–7pm, with same-day registration" (sourced to the DCBOE 2026 Primary Calendar PDF; the prior May 26 deadline reminder kept as a now-past-tense item). Sweep also covered: WaPo mayoral editorial endorsement (still none through May 28 — Tracker remains in standing follow-up); GW Hatchet May 26 forum-recap (HTTP 403 from WebFetch, treated as a likely re-write of the May 21 GW Today forum already in JLG/Goodweather/Johnson/Orange/Sampath news[], skipped pending clean access); fresh May 27 + May 28 candidate news (51st's May 27 piece is a generic civics roundup, no candidate-level news in the past 24 hours); WaPo May 14 schools-control opinion already in JLG's news[] from prior runs.)_
...
- [2026-06-01] DCBOE — Mail-ballot request page (canonical URL for the "request a mail ballot" flow; surfaced as the June 1 deadline alert this run for voters away from DC during the primary) — https://www.dcboe.org/voters/casting-your-vote/mail-ballot-request
...
### Mayor 2026
- [2026-06-01] DC NOW (DC Chapter of the National Organization for Women) — DCNOW Endorses D.C. Council Candidates in 2026 Special and Primary Elections (full 2026 slate; Lewis George the mayor pick; added as new alert + JLG/Schwalb/Mendelson/Owolewa/Silverman/Raj/Frumin/Parker/Allen news[] entries this run) — https://www.dc-now.org/post/dcnow-endorses-d-c-council-candidates-in-2026-special-and-primary-elections
- [2026-05-31] Washington Post — The rise of Janeese Lewis George, who could be D.C.'s first democratic socialist mayor (front-page closing-stretch profile; added to JLG news[] in run 18 as the canonical 5/31 citation) — https://www.washingtonpost.com/dc-md-va/2026/05/31/rise-janeese-lewis-george-who-could-be-dcs-first-democratic-socialist-mayor/
- [2026-05-31] Washington Post — In D.C. mayor's race, Kenyan R. McDuffie wants to offer 'more opportunities' for residents (companion closing-stretch profile, paired with the same-day JLG piece; added to McDuffie news[] in run 18) — https://www.washingtonpost.com/dc-md-va/2026/05/31/dc-mayoral-candidate-kenyan-mcduffie-wants-offer-more-opportunities-resident/
- [2026-05-29] Washington Examiner — DC Police Union hits Lewis George over pension-fund affordable-housing proposal (union called the proposal an "automatic disqualifier" on X after the May 18 Fox 5 debate; added to JLG news[] AND surfaced as a new top alert in run 18) — https://www.washingtonexaminer.com/news/campaigns/state/4574949/dc-police-union-janeese-lewis-george-leverage-pension-housing/
- [2026-05-28] Washington Examiner — Exclusive: Janeese Lewis George backs safe injection sites in DC for drug use (surfaces a May 2025 DSA endorsement-questionnaire response; added to JLG news[] in run 18 — note: the underlying statement is a year old, the news event is the surfacing) — https://www.washingtonexaminer.com/news/campaigns/4584819/janeese-lewis-george-backs-safe-drug-injection-site-dc/
- [2026-05-28] Axios DC — D.C. mayoral candidates sharpen final messages (closing-stretch race-state piece; added to McDuffie news[] in run 18 as the canonical "with under three weeks to go" framing) — https://www.axios.com/local/washington-dc/2026/05/28/dc-mayor-election-candidates-voting
- [2026-05-26] Washington Post (Opinion) — Janeese Lewis George wants to play roulette with D.C. pensions (the editorial-board opinion that prompted the DC Police Union's 5/29 response; documented here as the underlying piece, not added to JLG news[] since the Examiner reporting is the more granular primary citation) — https://www.washingtonpost.com/opinions/2026/05/26/janeese-lewis-george-wants-play-roulette-with-dc-pensions/
- [2026-05-28] Newsmax — D.C. Democrat Backs Safe Drug Injection Sites (national right-wing pickup of the Examiner exclusive; not added to news[], kept here for audit only) — https://www.newsmax.com/politics/opioids-mayor-dc/2026/05/28/id/1257806/
...
- [2026-05-28] Washington Blade (Opinion / Peter Rosenstein) — Dual endorsement for Independent Council-at-large: Patterson or Crawford (formalizes the cross-endorsement: rank Patterson #1, Crawford #2; added to both Crawford and Patterson news[] in run 19) — https://www.washingtonblade.com/2026/05/28/opinion-council-at-large-dc-patterson-crawford/
